...
import { CAN_LLM_EDIT_TYPES } from "./AnalyticGeneratedArtifactDetailPage";
    ...
    <div className="min-h-[calc(100vh-64px)] bg-[#F7F6F8]">
      <div className="mx-auto w-full max-w-6xl px-4 py-6 space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-[260px,minmax(0,1fr),260px]">
          {/* Левый сайдбар: список артефактов */}
          ...
          {/* Центр: предпросмотр файла / диаграммы */}
          ...
          <aside className="flex flex-col gap-3">
            ...
            <div className="mt-4 rounded-2xl border border-[#E3E1E8] bg-white p-3 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
              ...
              {canLlmEdit ? (
                <>
                  <p className="mb-2 flex items-start gap-1 text-[11px] text-[#C05621]">
                    ...
                    <span>
                      После применения правок содержимое текущего документа
