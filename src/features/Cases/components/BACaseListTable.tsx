  ...
  return (
    <div className="w-full bg-background">
      <div className="mx-auto max-w-6xl px-4 lg:px-0 py-8">
        ...
        <div className="hidden md:grid grid-cols-[minmax(0,2.1fr)_minmax(0,1.1fr)_minmax(0,1.1fr)_120px_32px] items-center px-6 py-2 text-xs font-medium text-[#888085]">
          <div>Название</div>
          <div>Статус</div>
          <div>Сотрудник</div>
        ...
        <div className="flex flex-col gap-3">
          {pagedCases.map((c) => {
            ...
            const employee =
              c.requester_name?.trim() || "Неизвестный сотрудник";
            ...
            return (
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-[minmax(0,2.1fr)_minmax(0,1.1fr)_minmax(0,1.1fr)_120px_32px] gap-3 items-center">
